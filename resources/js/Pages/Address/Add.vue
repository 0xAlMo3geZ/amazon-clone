    ...
    <AuthenticatedLayout>
        ...
        <div class="w-[500px] mx-auto text-2xl font-extrabold">
            ...
            <form @submit.prevent="submit">
                ...
                <select v-model="form.country" class="
                        w-full
                        border-gray-300
                        rounded-lg
                        shadow-md
                ...
                <div class="mt-3">
                    ...
                    <TextInput type="text" v-model="form.addr1" class="mt-1 block w-full" required
                        placeholder="Address line 1" />

                    <TextInput type="text" v-model="form.addr2" class="mt-1 block w-full" required
                ...
                <div class="mt-3">
                    <div class="flex gap-2">
                        <div class="w-full">
                            ...
                            <TextInput type="text" v-model="form.city" class="mt-1 block w-full" required
                                placeholder="City" />
                        </div>
                        ...
                        <div class="w-full">
                            ...
                            <TextInput type="text" v-model="form.postcode" class="mt-1 block w-full" required
